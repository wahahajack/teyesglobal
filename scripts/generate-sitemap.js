...
const staticPages = [
  ...
  { path: '/car-audio/subwoofers', source: 'src/pages/car-audio/CarAudioCategory.tsx', priority: '0.8' },
  { path: '/car-audio/bass-systems', source: 'src/pages/car-audio/CarAudioCategory.tsx', priority: '0.8' },
