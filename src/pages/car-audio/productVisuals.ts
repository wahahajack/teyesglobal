...
export const productVisuals = {
  ...
  "ts-08": product("ts-08", "TS-08", '8" Under-Seat Enclosed Subwoofer', ["260 W rated", "77 mm chassis height"], 394, 512),
  "ts-10": product("ts-10", "TS-10", '10" Under-Seat Enclosed Subwoofer', ["260 W rated", "25 Hz low-frequency response"], 398, 512),
  "10t3-d4": product("10t3-d4", "10T3-D4", '10" Standard-Depth Subwoofer Driver', ["400 W rated", "148.5 mm mounting depth"], 512, 311),
  "10t3s-v4": product("10t3s-v4", "10T3S-V4", '10" Thin-Line Subwoofer Driver', ["400 W rated", "89 mm mounting depth"], 512, 311),
  "10t6-v4": product("10t6-v4", "10T6-V4", '10" Standard-Depth Subwoofer Driver', ["500 W rated", "160.5 mm mounting depth"], 512, 312),
  "10t6s-v4": product("10t6s-v4", "10T6S-V4", '10" Thin-Line Subwoofer Driver', ["400 W rated", "84 mm mounting depth"], 512, 313),

  "10v8-v4": product("10v8-v4", "10V8-V4", '10" Competition Subwoofer Driver', ["600 W rated", "16 mm X-MAX"], 512, 312),
  "bxa3-10t3s-v4": product("bxa3-10t3s-v4", "BXA3/10T3S/V4", '10" Active Sealed Enclosed Subwoofer', ["460 × 340 × 139 mm", "13 kg"], 512, 385),
  "bx1-10t3s-v4": product("bx1-10t3s-v4", "BX1/10T3S/V4", '10" Passive Sealed Enclosed Subwoofer', ["460 × 340 × 139 mm", "13 kg"], 512, 380),
  "bx2-10t3s-v4": product("bx2-10t3s-v4", "BX2/10T3S/V4", '10" Passive Ported Enclosed Subwoofer', ["323 × 330 × 400 mm", "13 kg"], 512, 424),
  "bx4-10t3-d4": product("bx4-10t3-d4", "BX4/10T3/D4", '10" Passive Ported Enclosed Subwoofer', ["240 × 355 × 430 mm", "15 kg"], 512, 434),
